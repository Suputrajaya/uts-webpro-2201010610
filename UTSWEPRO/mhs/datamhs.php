<?php
    ...
    $koneksi = mysqli_connect(DBHOST, DBUSER, DBPASS, DBNAME, DBPORT) or die("Gagal koneksi ke DBMS");
        ...
        switch ($act){
            case "store":
                ...
                if($pass1 == $pass2){
                    ...
                    $prodi = $_POST["txPRODI"];
                    $idmhs = md5($nim);
                    $sql = "INSERT INTO tb_mahasiswa(nama, nim, prodi, pass, idmhs) VALUES('$nama', '$nim', '$prodi', '$pass1', '$idmhs');";
            ...
            case "update":
                ...
                if($pass1 == $pass2){
                    ...
                    $prodi = $_POST["txPRODI"];
                    $idmhs = $_POST["idmhs"];
                    $sql = "UPDATE tb_mahasiswa SET nama='$nama', nim='$nim', prodi='$prodi', pass='$pass1' WHERE idmhs='$idmhs';";
                    $hasil = mysqli_query($koneksi, $sql);
                    if($hasil){
                        $alert = "<script>
                        Swal.fire({
            ...
            case "destroy":
                $idmhs = $_POST['idmhs'];
                $sql = "DELETE FROM tb_mahasiswa WHERE idmhs='$idmhs';";
                $hasil = mysqli_query($koneksi, $sql);
                    if($hasil){
                        $alert = "<script>
                        Swal.fire({
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../user/datauser.php">Data User</a>
        </li>
      </ul>
    </div>
  </div>
